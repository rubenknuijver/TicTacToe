namespace TicTacToeWinForms
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button4
			// 
			...
			this.button4.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button5
			// 
			...
			this.button5.Location = new System.Drawing.Point(118, 133);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(100, 100);
			this.button5.TabIndex = 1;
			this.button5.Tag = "5";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button6
			// 
			...
			this.button6.Location = new System.Drawing.Point(224, 133);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(100, 100);
			this.button6.TabIndex = 1;
			this.button6.Tag = "6";
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button7
			// 
			...
			this.button7.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button8
			// 
			...
			this.button8.Location = new System.Drawing.Point(118, 239);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(100, 100);
			this.button8.TabIndex = 1;
			this.button8.Tag = "8";
			this.button8.UseVisualStyleBackColor = true;
			this.button8.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// button9
			// 
			...
			this.button9.Location = new System.Drawing.Point(224, 239);
			this.button9.Name = "button9";
			this.button9.Size = new System.Drawing.Size(100, 100);
			this.button9.TabIndex = 1;
			this.button9.Tag = "9";
			this.button9.UseVisualStyleBackColor = true;
			this.button9.Click += new System.EventHandler(this.TurnButton_Clicked);
			// 
			// Form1
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(336, 352);
